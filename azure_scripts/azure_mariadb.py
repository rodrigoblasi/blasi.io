...
"""This script collects metrics from azure mariadb."""
...
def parse_arguments():
    ...
    parser.add_argument("--metric-name", dest="metric_name",
                        help="Azure availables metrics: ['active_connections',\
                            'backup_storage_used','cpu_percent','memory_percent',\
...
def main():
    ...
    try:
        ...
        resource_id = azure_tags.get_resource_id_by_tag(args.sys_id,\
            credentials,subscription_id,'Microsoft.DBforMariaDB/servers')
