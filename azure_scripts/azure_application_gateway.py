...
"""This script collects metrics from azure Application Gateway."""
...
def parse_arguments():
    ...
    parser.add_argument("--metric-name", dest="metric_name",
                        help="Azure availables metrics: ['CapacityUnits','ComputeUnits',\
                            'CurrentConnections','FailedRequests',\
                            'ResponseStatus','TotalRequests','Throughput']",
                        required=True, type=str)
...
def main():
    ...
    try:
        ...
        azure_errors.throws('application-gateway')
