...
"""This script collects metrics from azure Express Route."""
...
def parse_arguments():
    ...
    parser.add_argument("--metric-name", dest="metric_name",
                        help="Azure availables metrics: ['ArpAvailability','BgpAvailability',\
...
def main():
    ...
    try:
        ...
        resource_id = azure_tags.get_resource_id_by_tag(args.sys_id,\
            credentials,subscription_id,'Microsoft.Network/expressRouteCircuits')
        ...
        azure_errors.throws('express-route')
