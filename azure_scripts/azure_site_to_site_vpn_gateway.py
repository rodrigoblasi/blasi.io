...
"""This script collects metrics from azure Site to Site VPN Gateway."""
...
def parse_arguments():
    ...
    parser.add_argument("--metric-name", dest="metric_name",
                        help="Azure availables metrics: ['TunnelAverageBandwidth',\
...
def main():
    ...
    try:
        ...
        resource_id = azure_tags.get_resource_id_by_tag(args.sys_id,\
            credentials,subscription_id,'Microsoft.Network/virtualNetworkGateways')
        ...
        if not args.metric_name == 'TunnelAverageBandwidth':
            aggregation = 'total'
        ...
        azure_errors.throws('site-to-site-vpn')
