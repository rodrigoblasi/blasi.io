...
"""This script collects metrics from azure Traffic Manager."""
...
def parse_arguments():
    ...
    parser.add_argument("--statistic", dest="statistic",
                        help="Azure availables statistics: ['total','maximum']",
                        required=True, type=str)
...
def main():
    ...
    try:
        ...
        resource_id = azure_tags.get_resource_id_by_tag(args.sys_id,\
            credentials,subscription_id,'Microsoft.Network/trafficManagerProfiles')
