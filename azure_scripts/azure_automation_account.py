...
"""This script collects metrics from Automations Account."""
import argparse
...
def parse_arguments():
    ...
    parser.add_argument("--statistic", dest="statistic",
                        ...
                        required=True, type=str)
    parser.add_argument("--runbook", dest="runbook",
                        help="<Optional> Metric dimension to be collected",
                        required=False, type=str)
    parser.add_argument("--status", dest="status",
                        help="<Optional> Metric dimension to be collected",
                        required=False, type=str)
    parser.add_argument("--software-update-configuration-name",
                        dest="software_update_configuration_name",
                        help="<Optional> Metric dimension to be collected",
                        required=False, type=str)
    parser.add_argument("--target-computer", dest="target_computer",
                        help="<Optional> Metric dimension to be collected",
                        required=False, type=str)
    parser.add_argument("--software-update-configuration-run-id",
                        dest="software_update_configuration_run_id",
                        help="<Optional> Metric dimension to be collected",
                        required=False, type=str)
...
def main():
    ...
    try:
        ...
        azure_errors.throws('automation-account')
